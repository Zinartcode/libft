...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2017/06/18 17:33:18 by azinnatu          #+#    #+#              #
#    Updated: 2017/07/05 16:28:46 by azinnatu         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
ft_itoa.c ft_bzero.c ft_lstadd.c ft_lstdel.c ft_lstdelone.c ft_lstiter.c \
...
ft_wordcount.c ft_swap.c ft_lenght.c ft_new_line.c ft_remove_digits.c \
ft_remove_letters.c \
